      ...
      child: Card(
        ...
        child: InkWell(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: Image.asset(assetImage, fit: BoxFit.cover, errorBuilder: (c, e, s) => Container(color: overlayColor.withOpacity(0.5), child: const Center(child: Icon(Iconsax.gallery_slash, color: Colors.white70, size: 40)))),
              ),
              Positioned.fill(
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [overlayColor.withOpacity(0.8), overlayColor.withOpacity(0.5)],
