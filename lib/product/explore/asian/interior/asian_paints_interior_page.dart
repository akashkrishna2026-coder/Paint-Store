          ...
          children: [
            Positioned.fill(
              child: Image.asset(
                assetImage,
                fit: BoxFit.cover,
                errorBuilder: (c, e, s) => Container(color: overlayColor.withOpacity(0.5), child: const Center(child: Icon(Iconsax.gallery_slash, color: Colors.white70, size: 40))),
              ),
            ),
            Positioned.fill(
              child: Container(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(subtitle, style: GoogleFonts.poppins(fontSize: 13, color: Colors.white.withOpacity(0.8))),
