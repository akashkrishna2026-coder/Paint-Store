      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 16),
            Expanded(child: Text(_brochureFileName ?? _product.brochureUrl.split('/').last.split('?').first.replaceAll('%2F', '/') ?? 'Select Brochure PDF...', style: GoogleFonts.poppins(), overflow: TextOverflow.ellipsis)),
          ],
        ),
      ),
    );
