...
class _DeliveryLocationPageState extends State<DeliveryLocationPage> {
  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      Position position = await Geolocator.getCurrentPosition(
          desiredAccuracy: LocationAccuracy.medium); // Medium accuracy is often enough for address
  ...
  void _confirmAndProceed() {
    ...
    print("Position: Lat: ${_currentPosition?.latitude}, Lon: ${_currentPosition?.longitude}");
