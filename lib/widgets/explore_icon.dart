        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Colors.black.withOpacity(0.4), blurRadius: widget.size * 0.15, offset: Offset(widget.size * 0.08, widget.size * 0.08)),
                BoxShadow(color: Colors.white.withOpacity(0.8), blurRadius: widget.size * 0.1, offset: Offset(-widget.size * 0.04, -widget.size * 0.04)),
              ],
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Colors.black.withOpacity(0.1), blurRadius: widget.size * 0.05, spreadRadius: -widget.size * 0.02, offset: Offset(0, widget.size * 0.02)),
                BoxShadow(color: Colors.white.withOpacity(0.6), blurRadius: widget.size * 0.03, spreadRadius: -widget.size * 0.01, offset: Offset(0, -widget.size * 0.01)),
              ],
            ),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Colors.black.withOpacity(0.5), blurRadius: widget.size * 0.03, offset: Offset(widget.size * 0.01, widget.size * 0.01)),
              ],
            ),
          ),
        ],
